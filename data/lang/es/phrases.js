...
window.langDB.wrongSub = "Esta es mi imagen";
window.langDB.wrongBtn = "Aprende más";
window.langDB.wrongMoreBtn = "Close";
window.langDB.victoryTitle = "¡Enhorabuena!";
window.langDB.victorySub = "¡Se te da muy bien el arte!";
