    ...
    <div class="card-block">
      <div class="row mr-0">
        <div class="col-2 text-right">
          <img width="60" :src="'img/painters/' + answer.id + '.png'" />
        </div>
        <div class="col-6">
          <span class="small">{{ answer.name.split(" ")[0] }}</span>
...
Vue.component('answers', {
  template: `
  <div>
    <painter v-for="answer in possibleAnswers" :answer="answer"></painter>
  </div>
  `,
  computed: {
    possibleAnswers() {
